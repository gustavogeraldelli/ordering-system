...
import com.gustavogeraldelli.course.entities.Payment;
import com.gustavogeraldelli.course.entities.Product;
import com.gustavogeraldelli.course.entities.User;
import com.gustavogeraldelli.course.entities.enums.OrderStatus;
import com.gustavogeraldelli.course.repositories.CategoryRepository;
import com.gustavogeraldelli.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2019-07-20T03:23:10Z"), OrderStatus.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:20Z"), OrderStatus.WAITING_PAYMENT, u1);
